...
export default function DietPlan() {
  ...
  // Dynamic meal plan from record or fallback to mock
  const mealPlan = user?.assignedDiet?.meals || {
    breakfast: {
      time: "7:00 AM",
      name: "Breakfast",
      icon: "☀️",
      items: ["4 Scrambled Eggs", "2 Whole Wheat Toast", "2 tbsp Peanut Butter", "1 Banana"],
      calories: 520, protein: 35, carbs: 45, fats: 18
    },
    midMorning: {
      time: "10:30 AM",
      name: "Mid-Morning Snack",
      icon: "🍎",
      items: ["Greek Yogurt 200g", "Mixed Nuts 30g", "1 Apple"],
      calories: 350, protein: 20, carbs: 30, fats: 15
    },
    lunch: {
      time: "1:00 PM",
      name: "Lunch",
      ...
      calories: 680, protein: 55, carbs: 70, fats: 12
    },
    evening: {
      time: "5:00 PM",
      name: "Evening Snack",
      icon: "🥤",
      items: ["Whey Protein Shake", "2 Rice Cakes"],
      calories: 320, protein: 30, carbs: 25, fats: 8
    },
    dinner: {
      time: "8:00 PM",
      name: "Dinner",
      icon: "🌙",
      items: ["Grilled Paneer Tikka 150g", "3 Whole Wheat Roti", "Dal (Lentils)"],
      calories: 550, protein: 40, carbs: 55, fats: 12
    }
  };
  ...
  // Goals
  const goals = user?.assignedDiet?.goals || {
    calories: 2800,
    protein: 160,
    carbs: 280,
    fats: 65
           ...
           <Card className="p-8 bg-gradient-to-br from-[#1e1b4b]/50 to-darkBg border border-purple-500/20 relative overflow-hidden">
             <div className="relative z-10">
               ...
               <p className="text-zinc-400 leading-relaxed text-sm">
                 "Focus on hitting your protein targets consistently. If you feel hungry between meals, 
                 add a protein shake. Stay hydrated with at least 3L water daily. Great progress this week! 💪"
               </p>
